...
def test4(k):
    ...
    anr=StringVar(t1)
    l_user_id=Label(t1, text='User I.D. :',font=tkFont.Font(family="Times New Roman", size=16),anchor='w', borderwidth=2, relief="solid", width=10, height=2)
    user_id=Entry(t1,font=tkFont.Font(family="Times New Roman", size=30),textvariable=anr, borderwidth=2, relief="solid")
    next_1_button=Button(t1, text='Next',font=tkFont.Font(family="Times New Roman", size=16),command=getting_user_details,borderwidth=2, relief="solid", width=12,height=2)
    l_user_id.place(x=615, y=300)
    user_id.place(x=720, y=300)
    back_button=Button(t1, text='Go Back',font=tkFont.Font(family="Times New Roman", size=16), command=back,borderwidth=2, relief="solid", width=10,height=2)
